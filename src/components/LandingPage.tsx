...
const safetyHighlights = [
  ...
  {
    title: '必要なときだけコピー',
    description: 'コードはその場でクリップボードにコピーされ、登録が終われば自動的に上書きされます。',
  },
]

const howToSteps = [
  'まめコミポイントキャンペーンの案内を確認し、対象商品のシリアルコードを手元に準備します。',
  '本ページの「スキャンする」ボタンを押してカメラを起動し、パッケージ裏面のシリアルをガイドに合わせます。',
  '端末を動かさずに構えていると自動で読み取り、登録画面を開くボタンが表示されます。',
  'ボタンから登録ページを開き、ログイン後のシリアル欄にコピーしたコードを貼り付ければ完了です。',
]
