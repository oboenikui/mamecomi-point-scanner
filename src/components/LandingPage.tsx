...
const highlightFeatures = [
  ...
  },
  {
    title: 'シリアル登録ページに直送',
    description:
      'スキャン完了後もスムーズにまめコミの登録画面を開けます。ログイン後の入力欄に貼り付けるだけで、登録がスムーズに完了します。',
    badge: 'Workflow',
  },
]
...
const safetyHighlights = [
  {
    title: '端末の中だけで処理',
    description: '撮影した映像も読み取ったコードも、あなたの端末の中だけで処理されます。外部サーバーには送られません。',
  },
  {
    title: '操作のたびに確認',
    description: 'スキャン開始や登録ページへの遷移は、すべてあなたの操作をきっかけに実行されます。',
  },
  {
    title: 'コードは一時保存',
    description: '読み取ったコードは貼り付け用に一時保存するだけで、どこにも送信しません。',
  },
]
...
const howToSteps = [
  ...
  'ボタンから登録ページを開き、ログイン後のシリアル入力欄に一時保存されたコードを貼り付ければ完了です。',
]
